...
public class GodMode : MonoBehaviour
{
    ...
    [SerializeField] KeyCode toucheActivation = KeyCode.X;
                     bool activée = true;
    ...
    private void EnableOrDisableGodMode()
    {
        ...
        if (activée)
        {
            ...
            vitesseDeplacement = temp;
            
        }
        else
        {
            GetComponent<Camera>().depth = -1;
            vitesseDeplacement = 0f;
        }
    }
